   ...
   #pragma omp parallel
{
    ...
    {
       #pragma omp section
         (void)iteracion(10000000,fptr);//20//2000900
       #pragma omp section
         (void)iteracion(10000000,fptr1);//200//2000400
       #pragma omp section
         (void)iteracion(10000000,fptr2);//2000//2000700
       #pragma omp section
         (void)iteracion(10000000,fptr3);//20000//2000800
       #pragma omp section
         (void)iteracion(10000000,fptr4);//200000//2000500
       #pragma omp section
         (void)iteracion(10000000,fptr5);//2000000//2000100
   }
}
